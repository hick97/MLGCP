...
void Grafo::AddVirtualEdges(Data *d, int cor){
...
void Grafo::VirtualEdges()
{
    ...
    while(cor != this->nLabels){ // Percorre todas as minhas labels, montando as matrizes de cada uma.
        // Grafo atual.
